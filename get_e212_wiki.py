...
# Some countries have MCCs without any MNCs allocated, since we base the data
# on the list of MNCs we need a way to include additional MCCs.
EXTRA_COUNTRY_MCC = {
    "406": "IN",
    "316": "US",
    "332": "VI",
...
def main() -> None:
    ...
    for mcc, country_code in EXTRA_COUNTRY_MCC.items():
        plmns_to_country[int(mcc)] = country_code
